...
BEGIN
    ...
    -- Ejecutamos acciones que modifican datos y los revisan
    añadir_prefijo;
    auditar_correos;
    ...
    -- Ejecutamos funciones que nos devuelven un cálculo matemático o conteo
    ...
    DBMS_OUTPUT.PUT_LINE(CHR(10) || 'Script 6 completado: Validación de PL/SQL superada.');
END;
/